...
// source: github.com/geiqin/micro/internal/usage/proto/usage.proto
...
func init() {
	proto.RegisterFile("github.com/geiqin/micro/internal/usage/proto/usage.proto", fileDescriptor_usage_7cdccb5f3bba2052)
}
