...
import (
	...
	ahandler "github.com/geiqin/go-micro/api/handler"
	aapi "github.com/geiqin/go-micro/api/handler/api"
	"github.com/geiqin/go-micro/api/handler/event"
	ahttp "github.com/geiqin/go-micro/api/handler/http"
	arpc "github.com/geiqin/go-micro/api/handler/rpc"
	"github.com/geiqin/go-micro/api/handler/web"
	"github.com/geiqin/go-micro/api/resolver"
	"github.com/geiqin/go-micro/api/resolver/grpc"
	"github.com/geiqin/go-micro/api/resolver/host"
	"github.com/geiqin/go-micro/api/resolver/path"
	"github.com/geiqin/go-micro/api/router"
	regRouter "github.com/geiqin/go-micro/api/router/registry"
	"github.com/geiqin/go-micro/api/server"
	"github.com/geiqin/go-micro/api/server/acme"
	"github.com/geiqin/go-micro/api/server/acme/autocert"
	"github.com/geiqin/go-micro/api/server/acme/certmagic"
	httpapi "github.com/geiqin/go-micro/api/server/http"
	log "github.com/geiqin/go-micro/logger"
	"github.com/geiqin/go-micro/sync/memory"
	"github.com/geiqin/micro/v2/client/api/auth"
	"github.com/geiqin/micro/v2/internal/handler"
	"github.com/geiqin/micro/v2/internal/helper"
	"github.com/geiqin/micro/v2/internal/namespace"
	rrmicro "github.com/geiqin/micro/v2/internal/resolver/api"
	"github.com/geiqin/micro/v2/internal/stats"
