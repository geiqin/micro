...
// source: github.com/geiqin/micro/v2/api/proto/api.proto
...
func init() {
	proto.RegisterFile("github.com/geiqin/micro/v2/api/proto/api.proto", fileDescriptor_api_f8ef31c2e6dafc0b)
}
