# Micro [![License](https://img.shields.io/:license-apache-blue.svg)](https://opensource.org/licenses/Apache-2.0) [![GoDoc](https://godoc.org/github.com/geiqin/micro?status.svg)](https://godoc.org/github.com/geiqin/micro) [![Travis CI](https://travis-ci.org/micro/micro.svg?branch=master)](https://travis-ci.org/micro/micro) [![Go Report Card](https://goreportcard.com/badge/micro/micro)](https://goreportcard.com/report/github.com/geiqin/micro)
...
- **go-micro:** Leverage the powerful [Go Micro](https://github.com/geiqin/go-micro) framework to develop microservices easily and quickly.
...
```
go get github.com/geiqin/micro
```
