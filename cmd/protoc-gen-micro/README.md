...
```
go get github.com/geiqin/micro/cmd/protoc-gen-micro@master
```
...
The proto generates a `RegisterGreeterHandler` function with a [api.Endpoint](https://godoc.org/github.com/geiqin/go-micro/api#Endpoint). 
